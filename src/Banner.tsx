        ...
        <section className='container mx-auto px-4'>
            <div className='flex flex-col md:flex-row md:items-center'>
                <div className='flex-1 pt-4'>
                    <h1 className='text-text-primary font-bold text-3xl text-center md:text-start md:text-5xl lg:text-6xl pb-1'>Build Your Ideal</h1>
                    <h2 className='font-bold text-4xl lg:text-6xl text-center md:text-start brand-color md:pb-8'>Development Stack</h2>
                    <p className='text-secondary md:text-xl text-center md:text-start leading-6 md:leading-8 py-4 md:py-0'>Explore frontend, backend, database, and tooling options,
